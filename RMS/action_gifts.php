...
// Check if request is approved (leg_id = 2)
...
$stmt->execute();
$stmt->bind_result($staff_no, $staff_name, $contact, $sub_category, $item_desc, $event_detail, $cpr_remark, $approved_by_name);
$stmt->fetch();
$stmt->close();
...
<html>
<head>
    <title>Action - Mementoes & Gifts</title>
    <style>
        body {
            display: flex;
...
<div class="form-container">
    ...
    <form method="post">
        ...
        <div class="radio-group">
            <label><input type="radio" name="next_leg_id" value="84" required> Procured</label>
            <label><input type="radio" name="next_leg_id" value="85"> Issued to user</label>
        </div>
