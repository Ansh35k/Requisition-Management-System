...
<html>
<head>
    <title>Action - Rubber Stamps</title>
    <style>
        body {
            display: flex;
...
<div class="form-container">
    ...
    <form method="post">
        ...
        <div class="radio-group">
            <label><input type="radio" name="next_leg_id" value="34" required> Stamp Made</label>
            <label><input type="radio" name="next_leg_id" value="35"> Stamp Issued</label>
