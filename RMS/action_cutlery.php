...
$stmt->execute();
$stmt->bind_result($staff_no, $staff_name, $contact, $sub_category, $item_desc, $purpose, $cpr_remark, $approved_by_name);
$stmt->fetch();
$stmt->close();
...
<div class="form-container">
    ...
    <textarea rows="3" readonly><?= htmlspecialchars($item_desc) ?></textarea>

    <label>Purpose:</label>
    <textarea rows="3" readonly><?= htmlspecialchars($purpose) ?></textarea>
    ...
    <form method="post">
        ...
        <div class="radio-group">
            <label><input type="radio" name="next_leg_id" value="24" required> Issued</label>
        </div>
