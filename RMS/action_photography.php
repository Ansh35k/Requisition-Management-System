...
<div class="form-container">
    ...
    <form method="post">
        ...
        <div class="radio-group">
            <label><input type="radio" name="next_leg_id" value="64" required> Photography Completed</label>
            <label><input type="radio" name="next_leg_id" value="65"> Data Shared with User</label>
        </div>
