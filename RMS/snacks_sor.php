...
$category_id = 7; // Beverages & Snacks
...
if ($role === 'admin') {
    // Admin sees all records in the category
    $sql = "SELECT  
                r.Req_id, 
    ...
    // Normal user sees only their own entries
    $sql = "SELECT  
                r.Req_id, 
                DATE_FORMAT(r.add_dt, '%d-%m-%Y') AS req_date,
                r.event_detail, 
...
<html>
<head>
    <title>Beverages & Snacks Requisition Status</title>
    <style>
        body {
...
<div class="container">
    <h2>Status of Beverages & Snacks Requisition</h2>
