...
<html>
<head>
    <title>Furniture Requisition Status</title>
    <style>
        body {
...
<div class="container">
    <h2>Status of Furniture Requisition</h2>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?= htmlspecialchars(date('d-m-Y', strtotime($row['req_date']))) ?></td>
