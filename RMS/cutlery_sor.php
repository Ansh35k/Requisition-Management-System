...
$category_id = 2; // 2 = Cutlery
$staffno = $_SESSION['staff'];

// Get the user's role (admin or user)
$role = '';
...
// SQL with dynamic filtering based on role
if ($role === 'admin') {
    // Admin: view all requisitions in this category
    $sql = "SELECT  
                r.Req_id, 
                r.add_dt,
                r.sub_category, 
    ...
    // Normal user: view only their own requisitions
    $sql = "SELECT  
                r.Req_id, 
                r.add_dt,
                r.sub_category, 
...
<html>
<head>
    <title>Cutlery Requisition Status</title>
    <style>
        body {
...
<div class="container">
    <h2>Status of Cutlery Requisition</h2>
